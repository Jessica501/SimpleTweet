...
While creating the app, I had some issues with UI. Sometimes things wouldn't look the way I expected it to and I didn't fully understand why. Also I'm still having some issues with the API calls. It seems that sometimes there are errors making network requests and I don't know why those issues are occuring. 
